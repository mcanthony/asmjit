...
static void dumpSizeOf(void) {
  ...
  DUMP_TYPE(asmjit::ASNode);
  DUMP_TYPE(asmjit::ASInst);
  DUMP_TYPE(asmjit::ASJump);
  DUMP_TYPE(asmjit::ASData);
  DUMP_TYPE(asmjit::ASAlign);
  DUMP_TYPE(asmjit::ASLabel);
  DUMP_TYPE(asmjit::ASComment);
  DUMP_TYPE(asmjit::ASSentinel);
  DUMP_TYPE(asmjit::ASFunc);
  DUMP_TYPE(asmjit::ASCall);
